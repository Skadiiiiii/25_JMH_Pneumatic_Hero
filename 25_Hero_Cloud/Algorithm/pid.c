...
{	
	...
	pid_init(&motor_pid_Cas_Pitch.inner,15.0f,0.0f,70.0f, 800  , 30000);//pitch pid 内环速度, kp=250, ki=150, kd=300, output limit = 30000
	pid_init(&motor_pid_Cas_Pitch.outer,7.0f,0.0f, 40.0f, 30000, 15000);			 //pitch pid 外环角度, kp=0.75,ki=0  , kd=0  , output limit = 15000
