...
#define       LED_YELLOWMeaning                 "BIUBIUBIU"
#define       LED_GREENMeaning                  "WOLF_Fire"
#define       LED_ORANGEMeaning                 "System_Status"
...
extern RC_ID robot_client_ID; //Self ID 
...
ID: 0x0101          Byte: 4       场地事件数据                   发送频率 1Hz
ID: 0x0102          Byte: 4       场地补给站动作标识数据         动作改变后发送
ID: 0X0104          Byte: 3       裁判警告数据                   警告发生后发送/Other time 1Hz
ID: 0x0105          Byte: 3       飞镖发射口倒计时               发送频率 1Hz
ID: 0X0201          Byte: 13      机器人状态数据                 发送频率 10Hz
ID: 0X0202          Byte: 16      实时功率热量数据               发送频率 50Hz
ID: 0X0203          Byte: 16      机器人位置数据                 发送频率 1Hz
ID: 0X0204          Byte: 6       机器人增益数据                 发送频率 3Hz
ID: 0X0205          Byte: 2       空中机器人能量状态数据         发送频率 1Hz，只有空中机器人主控发送
ID: 0X0206          Byte: 1       伤害状态数据                   伤害发生后发送
ID: 0X0207          Byte: 7       实时射击数据                   子弹发射后发送
ID: 0X0208          Byte: 6       子弹剩余发送数                 发送频率 10Hz
ID: 0X0209          Byte: 4       机器人RFID状态                 发送频率 3Hz
ID: 0x020A          Byte: 6       飞镖机器人客户端指令书         发送频率 3Hz
ID: 0x020B					Byte: 40			Ground robot location data     发送频率 1Hz
ID: 0x020C					Byte: 6				Radar marking progress data		 发送频率 1Hz(Radar)
ID:	0x020D					Byte: 4				Sentinel autonomous decision information synchronization  发送频率 1Hz(Sentinel)
ID:	0x020E					Byte: 1				Radar autonomous decision information synchronization	  	发送频率 1Hz(Radar)
ID: 0X0301          Byte: 128     机器人间交互数据              发送方触发发送    上限频率 10Hz
ID: 0x0302          Byte: 30      自定义控制器交互数据接口      客户端触发发送    上限频率 30Hz			[image transmission]
ID: 0x0303          Byte: 15     	客户端小地图交互数据           触发发送
ID: 0x0304          Byte: 12      键盘、鼠标信息                 通过图传串口发送30Hz								[image transmission]
ID: 0x0305					Byte: 10			The player side minimap receives radar data			上限频率 10Hz			[~~]
ID: 0x0306					Byte: 8				Custom controller interacts with player side data		 发送方触发发送    上限频率 30Hz
ID: 0x0307					Byte: 108			The player side minimap receives sentinel data/ Semi-automatic robot  发送频率 1Hz
ID: 0x0308					Byte: 34			The player side minimap receives the robot data 	发送频率 3Hz
*/
...
#define       Judge_Robot_RFID                   0x0209
#define       Judge_Dart_Client                  0x020A
#define       Judge_Custom_controller						 0x0302
#define       Judge_key													0x0304
/***************************DATA_Length*************************/
/*Calculation:frame_header(5-byte)+cmd_id(2-byte)+data(n-byte)+frame_tail(2-byte,CRC16)*/
#define       JudgeLength_Robot_State            22
#define       JudgeLength_Power_Heat             25
#define 				JudgeLength_Robot_HP							 41
#define 			JudgeLength_RealTimeShoot					 16
#define 				JudgeLength_Remaining_Rounds			 15
#define       JudgeLength_Custom_controller			 39
...
typedef struct
{
	...
	uint8_t InfoUpdataFlag;
}ext_custom_controller_t;
/*ID: 0x0304    Byte: 12    AutoSet*/
typedef struct
{
	union
	{
...
extern ext_game_robot_HP_t ext_game_robot_HP;
extern ext_bullet_remaining_t ext_bullet_remaining;
extern ext_custom_controller_t ext_custom_controller;
extern ext_shoot_data_t ext_shoot_data;
extern RC_ID robot_client_ID; //Self ID 

extern uint8_t JudgeSystem_rxBuff[389u]; 
